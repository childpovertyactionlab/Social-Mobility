...
#import shape files
zip.shape <- st_read("Social-Mobility/GIS/Shapefiles/sm_zcta.shp")
place.shape <- st_read("Social-Mobility/GIS/Shapefiles/sm_places.shp")
tract.shape <- st_read("Social-Mobility/GIS/Shapefiles/sm_tracts.shp")
counties.shape <- st_read("Social-Mobility/GIS/Shapefiles/sm_counties.shp")
