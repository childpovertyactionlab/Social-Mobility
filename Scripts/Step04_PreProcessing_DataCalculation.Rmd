...
voter_precincts_2020 <- st_read("Data Library/Texas Elections/Dallas County Elections/Precinct Shapefiles/2020 Precincts/DallasCoSubPrecincts.shp")
#voter_precincts_2018 <- st_read("Data Library/Dallas County Elections/Precinct Shapefiles/2018 Precincts/Subprecinct17A2.shp")
voter_precincts_2016 <- st_read("Data Library/Texas Elections/Dallas County Elections/Precinct Shapefiles/2016 Precincts/Subprecinct15.shp")
...
voter_precincts_2016 <- voter_precincts_2016 %>%
  select(PCT_BALLOT, geometry) %>%
  rename(precinct = PCT_BALLOT)
...
vote_change <- full_join(vote2020, vote2016)
