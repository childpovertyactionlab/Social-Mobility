...
plot(statehouse.merge$geometry)
```
...
geojsonio::geojson_write(statehouse.merge, file = "Social-Mobility/Data/Intermediate/sm_statehouse.geojson")
geojsonio::geojson_write(statesenate.merge, file = "Social-Mobility/Data/Intermediate/sm_statesenate.geojson")
geojsonio::geojson_write(congressdistrict.merge, file = "Social-Mobility/Data/Intermediate/sm_fedcongress.geojson")
```
